...
📁 Project Structure
AI_BASED_ATTENDANCE_SYSTEM-main/ │ ├── app.py # Main Flask app ├── haarcascade_frontalface_default.xml # Face detection model ├── Attendance/ # Stores attendance CSV files ├── face_recognition_flask/ # Core face recognition module ├── static/ # Static assets (CSS, JS, images) ├── background.png # UI background image ├── Capture.PNG # Capture button image └── README.md # Project documentation
